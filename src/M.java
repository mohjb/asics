...
public static class Util{ //utility methods
	...
	public static Object bPath(Map m,boolean isCreate,boolean isSet,Object[]p){
		int i=0,n=p==null?0:p.length-(isSet?1:0);
		do{	Object o=m==null||i>n?null:m.get( p[i] );
			Map x=o instanceof Map?(Map)o:null;
			if(isCreate && m==null && i<n)
				m.put(p[i],x=Util.mapCreate(  ));
			if(isSet && i==n){//&&x!=null
				o=p[i+1];
				m.put(p[i],o );
				return o;
